class TenguCaddy < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tengu-apps/tengu-caddy/releases/download/v2.11.2-3/tengu-caddy-macos-arm64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/tengu-apps/tengu-caddy/releases/download/v2.11.2-3/tengu-caddy-linux-arm64"
      sha256 "bbb6f80e6735a1aec2ca4101fc2e777ea3a41a24aef5264e90bf9a940c05f211"
    end

    on_intel do
      url "https://github.com/tengu-apps/tengu-caddy/releases/download/v2.11.2-3/tengu-caddy-linux-amd64"
